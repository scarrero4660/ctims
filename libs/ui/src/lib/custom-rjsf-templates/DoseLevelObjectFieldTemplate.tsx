...
import {isObjectEmpty, stringContains} from "../../../../../packages/ctims-commons/src/components/helpers";

const DoseLevelObjectFieldTemplate = (props: ObjectFieldTemplateProps) => {
  const {
    description,
    disabled,
    formContext,
...
export default DoseLevelObjectFieldTemplate;
